...
public class MediaItem implements Parcelable {
  ...
  public MediaItem(Parcel in) {
    ...
    if (!TextUtils.isEmpty(crop)) this.uriCropped = Uri.parse(crop);
    String origin = in.readString();
    if (!TextUtils.isEmpty(origin)) this.uriOrigin = Uri.parse(origin);
  }
  ...
  @Override public boolean equals(Object obj) {
    ...
    if (uriCropped == null) {
      if (other.uriCropped != null) return false;
    } else if (!uriCropped.equals(other.uriCropped)) return false;
    if (uriOrigin == null) {
      if (other.uriOrigin != null) return false;
    } else if (!uriOrigin.equals(other.uriOrigin)) return false;
    return true;
  }
